...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1778243562);
user_pref("app.update.lastUpdateTime.background-update-timer", 1778243562);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1778252908);
user_pref("app.update.lastUpdateTime.glean-addons-daily", 1778243562);
user_pref("app.update.lastUpdateTime.region-update-timer", 1777987296);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1778252880);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1778243562);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1778243562);
user_pref("app.update.migrated.updateDir3.F4FD8FBCE9DA97CE", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "87ca0aa7-6b50-442e-86ee-303762a268b5");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1777987002);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{2a03d384-2320-4465-816e-252d57a5d2a3}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20260313222112");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1778252880);
...
user_pref("captchadetection.lastSubmission", 1777987);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "3b526eaf-c143-4ba2-91e0-cf0fc7593230");
user_pref("datareporting.dau.cachedUsageProfileID", "b9132ec6-c8b5-4855-a85c-86bfc38b0af0");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"c43aec07-ce7a-4e26-b38d-7e8415ffb8c4\",\"formautofill@mozilla.org\":\"8c3a4354-492e-4b50-9676-b79fc0455e76\",\"ipp-activator@mozilla.com\":\"959ddc66-bbf8-4c6a-8ddf-47fca89f0522\",\"pictureinpicture@mozilla.org\":\"2acbcbe5-d05f-4351-a537-79130ac76cbe\",\"addons-search-detection@mozilla.com\":\"355b4674-3fba-42ac-8b59-a9edde8287d7\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"3a4ab181-6dcd-4ab6-8d47-52a047885124\",\"default-theme@mozilla.org\":\"36a15c91-3404-4f7a-9653-eab1135cfb2a\"}");
...
user_pref("idle.lastDailyNotification", 1778249714);
...
user_pref("media.gmp-manager.buildID", "20260313222112");
user_pref("media.gmp-manager.lastCheck", 1778243552);
user_pref("media.gmp-manager.lastEmptyCheck", 1778243552);
...
user_pref("nimbus.profileId", "e573ac14-9a0b-4a30-9f1c-4cb1d23ec8c2");
user_pref("pdfjs.enabledCache.state", false);
user_pref("permissions.isolateBy.userContext", true);
user_pref("places.database.lastMaintenance", 1778249716);
user_pref("plugin.state.flash", 0);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.clearOnShutdown_v2.formdata", true);
user_pref("privacy.popups.showBrowserMessage", false);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1778249714762");
...
user_pref("storage.vacuum.last.places.sqlite", 1778249714);
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "6479a37a");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1778252877);
